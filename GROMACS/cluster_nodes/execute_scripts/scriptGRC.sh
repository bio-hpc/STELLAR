...
execute "$gromacs5 mdrun${mpi}  -ntmpi 1  -ntomp 20 -s ${out_molec}_mdrum_simulation.tpr -cpi ${out_molec}_mdrum_simulation.cpt ${gpu} ${thrads} -append -deffnm ${out_molec}_mdrum_simulation -g ${out_aux}_mdrum_simulation.log"
