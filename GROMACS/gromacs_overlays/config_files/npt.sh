...
printf '%-20s %-2s %-20s %-40s\n'  "constraints"	      "=" "h-bonds"			"; only H-bonds constrained (2 fs, GPU-LINCS compatible)"		>> ${file_conf_npt}
...
printf '%-20s %-2s %-20s %-40s\n'  "tcoupl"				  "=" "V-rescale"	        "; velocity-rescaling (Bussi), GPU-update compatible"						>> ${file_conf_npt}
